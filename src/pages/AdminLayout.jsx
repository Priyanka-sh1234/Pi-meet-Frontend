  ...
  return (
    <Layout className="h-full w-full fixed">
      <Sider collapsible collapsed={collapsed} onCollapse={setCollapsed}>
        <div className="h-12 flex items-center justify-center bg-sky-100 rounded-md m-2 transition-all duration-300">
          {collapsed ? (
            <img
      ...
      <Layout>
       <Header className="px-6  flex justify-end items-center bg-white shadow-sm">
        <img src={notification} alt="notification" className="w-10 h-10 mr-5 hover:animate-pulse transition-all duration-300" />
